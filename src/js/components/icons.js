...
export class AddVariable extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            clicked: false
    ...
    render() {
        const { props } = this;
        const { style, handleClick, ...rest } = props;
        const svgStyle = getIconStyle(style).style;
        ...
        return !this.state.clicked ? (
            ...
            <span {...rest}>
                <svg
                    ...
                    viewBox="0 0 20 20"
                >
                    <path d="M2,20H18a2,2,0,0,0,2-2V2a2,2,0,0,0-2-2H2A2,2,0,0,0,0,2V18A2,2,0,0,0,2,20Zm2.707-9.707L7,12.586l8.293-8.293,1.414,1.414L7,15.414,3.293,11.707Z" />
                </svg>
            </span>
        );
    }
